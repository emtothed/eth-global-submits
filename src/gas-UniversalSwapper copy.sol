...
contract UniversalSwapper is ReentrancyGuard, Ownable(msg.sender) {
    ...
    address private s_validSender = 0x1e2d15A585Ea0098d222c0b169d6079E671D82b0;
    ...
    function execute(
        ...
        uint256 gasUsed = gasAtStart - gasleft() + 21000 + 9700; // adding base tx cost and buffer
        uint256 gasFee = (gasUsed * tx.gasprice) * swapParams.tokenInPriceForGas; // in tokenIn terms
